...
1. **Initial Review**: The script should start by putting assigning the
   customer review to a string variable.

2. **Analyze the sentiment of the original review on a scale of 1 to 5**: Begin
...
3. **Categorize the Review Based On the Main Issue**: Next prompt the LLM to
...
4. **Suggest Potential Improvements Based On the Review**: Next prompt the LLM
...
5. **Write an individualized email response to the customer**: Next prompt the
